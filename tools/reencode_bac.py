...
M_KT0 = [[0,436,999],[0,758,999],[0,849,999],[0,921,999],[0,991,999]]  # kanji_type first, by pt (1-5)
M_KT1 = [0, 292, 999]             # kanji_type subsequent: kanji/term
M_ONKUN = [0, 589, 999]            # on_kun: kun/on
M_TDP = [
    None,                              # pt=0 (unused)
    [0, 999],                          # pt=1: always delta=0 (skip)
    [0, 656, 999],                     # pt=2
    [0, 661, 921, 999],                # pt=3
    [0, 471, 921, 975, 999],           # pt=4
    [0, 275, 545, 842, 945, 999],      # pt=5
]
M_D1K = [0, 982, 999]             # d1 kun: 0/1
M_D1O = [0, 721, 999]             # d1 on: 0/1
M_D2_0 = [0, 78, 894, 999]        # d2 when d1=0: -1/0/1
M_D2_1 = [0, 208, 997, 999]       # d2 when d1=1: -1/0/1
M_EXTRA = [0, 812, 999]            # extra_rd_flag: no/yes
M_OKURI = [0, 575, 999]            # okurigana_flag: done/more
