...
(() => {
    ...
    resetWillChange = () => {
        ...
        requestAnimationFrame(() => {
            requestAnimationFrame(() => { table.style.willChange = 'transform'; });
        });
    };
